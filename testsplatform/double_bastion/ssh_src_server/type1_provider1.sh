...
function generate_tech1_data_files
{
    ...
    do
        ...
        do
            touch "$path/dataresult_127${fset}_30_${date}${hs}00_${date}${he}00.csv"
            touch "$path/dataresult_127${fset}_60_${date}${hs}00_${date}${he}00.csv"
        done
    done
}
...
function generate_tech2_data_files
{
    ...
    do
        ...
        for fset in ${functionsetids[@]}
        do
            touch "$path/dataresult_${fset}_30_${date}${hs}00_${date}${he}00_5CII.csv"
            touch "$path/dataresult_${fset}_60_${date}${hs}00_${date}${he}00_5CII.csv"
        done
    done
}
